...
function concat ($firstParams, $secondParams, $thirdParams) // Ma fonction 'test' contient mes deux variables initialisés plus haut.
{
...
<body>
  ...
  <p><?= concat ($firstname, $lastname, $age); ?></p>
</body>
</html>
